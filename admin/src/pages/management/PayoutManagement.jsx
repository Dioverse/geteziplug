...
export default function PayoutManagement() {
  ...
  const fetchData = async (pageNum) => {
    ...
    try {
      const res = await getRequest(
        `/admin/payouts?page=${pageNum}&limit=${pageSize}`
      );
  ...
  const handleView = async (item) => {
    try {
      const res = await getRequest(`/admin/payouts/${item.id}`);
  ...
  const handleSubmitApprove = async (e) => {
    ...
    try {
      await postRequest(`/admin/payouts/${selectedItem.id}/approve`, {
  ...
  const handleSubmitReject = async (e) => {
    ...
    try {
      await postRequest(`/admin/payouts/${selectedItem.id}/reject`, {
